...
VALUES (1, 'Поселок -> Город', 1, 4, {ts '2019-05-20 06:33:56'}, {ts '2019-05-20 07:30:12'}, 0);

INSERT INTO trips (id, direction, driver_id, number_passengers, start_dt, end_dt, version)
VALUES (2, 'Поселок -> Город', 2, 4, {ts '2019-05-20 06:45:11'}, {ts '2019-05-20 07:40:45'}, 0);

INSERT INTO trips (id, direction, driver_id, number_passengers, start_dt, end_dt, version)
VALUES (3, 'Поселок -> Город', 3, 4, {ts '2019-05-20 07:13:56'}, {ts '2019-05-20 8:05:12'}, 0);
...
INSERT INTO trips (id, direction, driver_id, number_passengers, start_dt, end_dt, version)
VALUES (4, 'Город -> Поселок', 1, 4, {ts '2019-05-20 17:35:55'}, {ts '2019-05-20 18:21:34'}, 0);

INSERT INTO trips (id, direction, driver_id, number_passengers, start_dt, end_dt, version)
VALUES (5, 'Город -> Поселок', 2, 4, {ts '2019-05-20 18:15:42'}, {ts '2019-05-20 19:01:55'}, 0);

INSERT INTO trips (id, direction, driver_id, number_passengers, start_dt, end_dt, version)
VALUES (6, 'Город -> Поселок', 3, 4, {ts '2019-05-20 18:59:02'}, {ts '2019-05-20 19:44:35'}, 0);
