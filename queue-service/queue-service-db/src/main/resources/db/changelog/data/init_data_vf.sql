...
VALUES (1, 1, 1, 4, {ts '2019-05-20 17:01:00'}, {ts '2019-05-20 17:01:00'}, {ts '2019-05-20 17:35:55'}, 1);

INSERT INTO queue (id, number, driver_id, number_passengers, start_dt, start_first_dt, end_dt, version)
VALUES (2, 1, 2, 4, {ts '2019-05-20 17:30:31'}, {ts '2019-05-20 17:35:55'}, {ts '2019-05-20 18:15:42'}, 1);

INSERT INTO queue (id, number, driver_id, number_passengers, start_dt, start_first_dt, end_dt, version)
VALUES (3, 1, 3, 4, {ts '2019-05-20 17:35:12'}, {ts '2019-05-20 18:15:42'}, {ts '2019-05-20 18:59:02'}, 1);
